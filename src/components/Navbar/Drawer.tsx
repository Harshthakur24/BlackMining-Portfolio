                                    ...
                                    <div className="flex h-full flex-col overflow-y-auto bg-white">
                                        ...
                                        <div className="px-6 py-6 border-t border-gray-100 bg-gray-50/50">
                                            <div className="space-y-4">
                                                <a href="tel:+91 89 89 89 89 93" className="flex items-center gap-3 text-gray-600 hover:text-gray-900 transition-colors duration-200">
                                                    <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                                    </svg>
                                                    <span className="text-sm font-medium">+91 89 89 89 89 93                                                    </span>
                                                </a>
                                                <a href="mailto:Blackminingjunk@gmail.com" className="flex items-center gap-3 text-gray-600 hover:text-gray-900 transition-colors duration-200">
                                                    ...
                                                    <span className="text-sm font-medium">Blackminingjunk@gmail.com</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
